 ...
 * that can be freely given out to clients.
 */
public enum EmptySubscription implements Subscription {
    ...
    /**
     * Calls onSubscribe on the target Subscriber with the empty instance
     * followed by a call to onError with the supplied error.
     * @param s
     * @param e
     */
    ...
    /**
     * Calls onSubscribe on the target Subscriber with the empty instance
     * followed by a call to onComplete.
     * @param s
     */

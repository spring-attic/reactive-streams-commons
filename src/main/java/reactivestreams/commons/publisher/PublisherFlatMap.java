...
//                    }
    ...
    static final class PublisherFlatMapMain2<T, R>
    extends CachedContainer<PublisherFlatMapInner2<R>>
    implements Subscriber<T>, Subscription, Receiver, MultiReceiver, Requestable, Completable, Producer,
               Cancellable, Backpressurable, Failurable {
        ...
        volatile Throwable error;
        @SuppressWarnings("rawtypes")
        static final AtomicReferenceFieldUpdater<PublisherFlatMapMain2, Throwable> ERROR =
                AtomicReferenceFieldUpdater.newUpdater(PublisherFlatMapMain2.class, Throwable.class, "error");
        ...
        volatile long requested;
        @SuppressWarnings("rawtypes")
        static final AtomicLongFieldUpdater<PublisherFlatMapMain2> REQUESTED =
                AtomicLongFieldUpdater.newUpdater(PublisherFlatMapMain2.class, "requested");
        
        volatile int wip;
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<PublisherFlatMapMain2> WIP =
                AtomicIntegerFieldUpdater.newUpdater(PublisherFlatMapMain2.class, "wip");
        
        @SuppressWarnings("rawtypes")
        static final PublisherFlatMapInner2[] EMPTY = new PublisherFlatMapInner2[0];
        
        @SuppressWarnings("rawtypes")
        static final PublisherFlatMapInner2[] TERMINATED = new PublisherFlatMapInner2[0];
        ...
        public PublisherFlatMapMain2(Subscriber<? super R> actual,
                Function<? super T, ? extends Publisher<? extends R>> mapper, boolean delayError, int maxConcurrency,
                Supplier<? extends Queue<R>> mainQueueSupplier, int prefetch, Supplier<? extends Queue<R>> innerQueueSupplier) {
            this.actual = actual;
            this.mapper = mapper;
        ...
        void cancelAllInner() {
            for (PublisherFlatMapInner2<R> inner : terminate()) {
                if (inner != null) {
                    inner.cancel();
                }
            }
        ...
        @SuppressWarnings("unchecked")
        @Override
        protected PublisherFlatMapInner2<R>[] newArray(int size) {
            return size == 0 ? EMPTY : new PublisherFlatMapInner2[size];
        }
        
        @SuppressWarnings("unchecked")
        @Override
        protected PublisherFlatMapInner2<R>[] terminatedArray() {
            return TERMINATED;
        }
        ...
        public void onNext(T t) {
            ...
            if (p instanceof Supplier) {
                ...
                PublisherFlatMapInner2<R> inner = new PublisherFlatMapInner2<>(this, prefetch, unique++);
                if (add(inner)) {
        ...
        void drainLoop() {
            ...
            for (;;) {
                ...
                // if the main is not done and requested is at zero, don't bother draining
                // or even looking at the subscribers array
                // just check for errors and cancellation
                if (!d && r == 0L) {
                    if (checkTerminated(d, false, a)) {
                        return;
                    }
                } else {
                    PublisherFlatMapInner2<R>[] as = get();
                    ...
                    if (checkTerminated(d, c == 0 && (sq == null || sq.isEmpty()), a)) {
                        return;
                    }
                    ...
                    if (r != 0L && c != 0) {
                        ...
                        for (int i = 0; i < n; i++) {
                            ...
                            PublisherFlatMapInner2<R> inner = as[j];
                            if (inner != null) {
                                d = inner.done;
                                Queue<R> q = inner.queue;
                                if (d && q == null) {
...
//                        n = as.length;
                        ...
                        for (int i = 0; i < n; i++) {
                            ...
                            PublisherFlatMapInner2<R> inner = as[i];
                            if (inner == null) {
                                continue;
                            }
        ...
        void innerError(PublisherFlatMapInner2<R> inner, Throwable e) {
            if (ExceptionHelper.addThrowable(ERROR, this, e)) {
                inner.done = true;
                if (!delayError) {
                    done = true;
        ...
        void innerNext(PublisherFlatMapInner2<R> inner, R v) {
            if (wip == 0 && WIP.compareAndSet(this, 0, 1)) {
                long r = requested;
        ...
        Queue<R> getOrCreateScalarQueue(PublisherFlatMapInner2<R> inner) {
            Queue<R> q = inner.queue;
            if (q == null) {
                q = innerQueueSupplier.get();
                inner.queue = q;
    ...
    static final class PublisherFlatMapInner2<R> 
    implements Subscriber<R>, Subscription, Producer, Receiver,
               Backpressurable,
               Cancellable,
               Completable,
        ...
        final PublisherFlatMapMain2<?, R> parent;
        ...
        volatile Subscription s;
        @SuppressWarnings("rawtypes")
        static final AtomicReferenceFieldUpdater<PublisherFlatMapInner2, Subscription> S =
                AtomicReferenceFieldUpdater.newUpdater(PublisherFlatMapInner2.class, Subscription.class, "s");
        ...
        volatile int once;
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<PublisherFlatMapInner2> ONCE =
                AtomicIntegerFieldUpdater.newUpdater(PublisherFlatMapInner2.class, "once");
        
        public PublisherFlatMapInner2(PublisherFlatMapMain2<?, R> parent, int prefetch, long index) {
            this.parent = parent;
            this.prefetch = prefetch;
            this.id = index;
            this.limit = prefetch - (prefetch >> 2);

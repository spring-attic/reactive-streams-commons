 ...
 */
public final class ParallelUnorderedReduce<T, R> extends ParallelPublisher<R> {
    ...
    public ParallelUnorderedReduce(ParallelPublisher<? extends T> source, Supplier<R> initialSupplier, BiFunction<R, T, R> reducer) {
        this.source = source;

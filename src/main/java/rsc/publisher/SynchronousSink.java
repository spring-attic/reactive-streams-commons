 ...
 */
public interface SynchronousSink<T> extends Trackable {
     ...
     * {@link SynchronousSink.Emission#isOk()} is the only successful signal, the other define the emission failure cause.
     *
     */
    enum Emission {

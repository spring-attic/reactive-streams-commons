 ...
 */
public final class ConnectablePublisherOnAssembly<T> extends ConnectablePublisher<T> implements Fuseable {

    final ConnectablePublisher<T> source;
    ...
    public ConnectablePublisherOnAssembly(ConnectablePublisher<T> source) {
        this.source = source;

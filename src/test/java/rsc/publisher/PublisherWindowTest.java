...
public class PublisherWindowTest {
    ...
    public void processorQueue2Null() {
        new PublisherWindow<>(PublisherNever.instance(), 1, 1, null, oqs);
    }

    @Test(expected = NullPointerException.class)
    public void overflowQueueNull() {
        new PublisherWindow<>(PublisherNever.instance(), 1, 1, pqs, null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void size1Invalid() {
        new PublisherWindow<>(PublisherNever.instance(), 0, pqs);
    }

    @Test(expected = IllegalArgumentException.class)
    public void size2Invalid() {
        new PublisherWindow<>(PublisherNever.instance(), 0, 2, pqs, oqs);
    }

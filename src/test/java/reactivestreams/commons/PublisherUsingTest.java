...
public class PublisherUsingTest {
    ...
    public void resourceSupplierNull() {
        new PublisherUsing<>(null, r -> PublisherEmpty.instance(), r -> { }, false);
    }

    @Test(expected = NullPointerException.class)
    public void sourceFactoryNull() {
        new PublisherUsing<>(() -> 1, null, r -> { }, false);
    }
    ...
    public void resourceThrowsEager() {
        ...
        new PublisherUsing<>(() -> { throw new RuntimeException("forced failure"); }, r -> new PublisherRange(1, 10), cleanup::set, false).subscribe(ts);
    ...
    public void factoryThrowsEager() {
        ...
        new PublisherUsing<>(() -> 1, r -> { throw new RuntimeException("forced failure"); }, cleanup::set, false).subscribe(ts);

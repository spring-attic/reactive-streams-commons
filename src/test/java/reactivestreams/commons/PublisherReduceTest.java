...
public class PublisherReduceTest {
    ...
    public void supplierThrows() {
        ...
        new PublisherReduce<Integer, Integer>(new PublisherRange(1, 10), () -> { throw new RuntimeException("forced failure"); }, (a, b) -> b).subscribe(ts);
    ...
    public void accumulatorThrows() {
        ...
        new PublisherReduce<>(new PublisherRange(1, 10), () -> 0, (a, b) -> { throw new RuntimeException("forced failure"); }).subscribe(ts);

...
public class PublisherResumeTest {
    ...
    public void error() {
        ...
        new PublisherResume<>(new PublisherError<>(new RuntimeException("forced failure")), v -> new PublisherRange(11, 10)).subscribe(ts);
    ...
    public void nextFactoryThrows() {
        ...
        new PublisherResume<Integer>(new PublisherError<>(new RuntimeException("forced failure")), v -> { throw new RuntimeException("forced failure 2"); }).subscribe(ts);
    ...
    public void nextFactoryReturnsNull() {
        ...
        new PublisherResume<Integer>(new PublisherError<>(new RuntimeException("forced failure")), v -> null).subscribe(ts);

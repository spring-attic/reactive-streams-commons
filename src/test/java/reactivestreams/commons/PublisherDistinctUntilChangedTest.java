...
public class PublisherDistinctUntilChangedTest {
    ...
    public void someRepetiton() {
        ...
        new PublisherDistinctUntilChanged<>(new PublisherArray<>(1, 1, 2, 2, 1, 1, 2, 2, 1, 2, 3, 3), v -> v).subscribe(ts);
    ...
    public void keySelectorThrows() {
        ...
        new PublisherDistinctUntilChanged<>(new PublisherRange(1, 10), v -> { throw new RuntimeException("forced failure"); }).subscribe(ts);

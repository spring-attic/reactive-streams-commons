...
public class PublisherRepeatWhenTest {
    ...
    public void coldError() {
        ...
        new PublisherRepeatWhen<>(new PublisherRange(1, 2), v -> new PublisherError<>(new RuntimeException("forced failure"))).subscribe(ts);
    ...
    public void whenFactoryThrows() {
        ...
        new PublisherRepeatWhen<>(new PublisherRange(1, 2), v -> { throw new RuntimeException("forced failure"); }).subscribe(ts);
    ...
    public void repeaterErrorsInResponse() {
        ...
        new PublisherRepeatWhen<>(new PublisherRange(1, 2), v -> new PublisherMap<>(v, a -> { throw new RuntimeException("forced failure"); })).subscribe(ts);

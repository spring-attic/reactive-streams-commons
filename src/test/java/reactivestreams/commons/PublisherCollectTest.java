...
public class PublisherCollectTest {
    ...
    public void supplierThrows() {
        ...
        new PublisherCollect<>(new PublisherRange(1, 10), () -> { throw new RuntimeException("forced failure"); }, (a, b) -> { }).subscribe(ts);
    ...
    public void supplierReturnsNull() {
        ...
        new PublisherCollect<>(new PublisherRange(1, 10), () -> null, (a, b) -> { }).subscribe(ts);
    ...
    public void actionThrows() {
        ...
        new PublisherCollect<>(new PublisherRange(1, 10), () -> 1, (a, b) -> { throw new RuntimeException("forced failure"); }).subscribe(ts);

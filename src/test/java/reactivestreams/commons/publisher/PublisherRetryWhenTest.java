...
public class PublisherRetryWhenTest {
    ...
    public void coldError() {
        ...
        new PublisherRetryWhen<>(rangeError, v -> new PublisherError<>(new RuntimeException("forced failure")))
          .subscribe(ts);
    ...
    public void whenFactoryThrows() {
        ...
        new PublisherRetryWhen<>(rangeError, v -> {
    ...
    public void repeaterErrorsInResponse() {
        ...
        new PublisherRetryWhen<>(rangeError, v -> new PublisherMap<>(v, a -> {
            throw new RuntimeException("forced failure");
        })).subscribe(ts);
